...
def inline(text):
    ...
    def link(match):
        ...
        if not target.startswith(('https://', 'http://')):
            ...
            target = 'https://www.takyejun.com/static/research/ai-readiness/rc4-candidate-5/' + name
...
def footer(canvas, doc):
    ...
    canvas.drawString(44, 26, "Yejun Tak | 0.1-rc.4-candidate.5 | Engineering commitment only")
...
def build(source, destination):
    ...
    if source.name == "rc4-candidate-5-external-packet.md":
    ...
    SimpleDocTemplate(str(destination), pagesize=letter, leftMargin=44, rightMargin=44,
                      topMargin=43, bottomMargin=53, title=source.stem + " - 0.1-rc.4-candidate.5",
...
def main():
    ...
    docs = {
        "protocol/0.1-rc.4-candidate.5/PROTOCOL.md": "Protocol-v0.1-rc.4-candidate.5.pdf",
        "protocol/0.1-rc.4-candidate.5/QUICK-6.md": "QUICK-6-v0.1-rc.4-candidate.5.pdf",
        "protocol/0.1-rc.4-candidate.5/FULL-PROFILE.md": "Full-Profile-v0.1-rc.4-candidate.5.pdf",
        "Pilot-Kit/rc4-candidate-5-external-packet.md": "External-Pilot-Packet-v0.1-rc.4-candidate.5.pdf",
    }
