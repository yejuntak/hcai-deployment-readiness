...
Protocol 0.1-rc.4-candidate.3 · MCP 0.2.0rc3 · Skill/contract 0.2.0-rc.3
...
These flags concern the proposed workflow, not just whether AI runs in production. False needs a defensible basis in the risk rationale; null means unresolved. Highest dimension or context floor wins. A short/simple screen does not lower a consequential workflow's tier. Do not provide a context answer solely to gain QUICK6 eligibility.
