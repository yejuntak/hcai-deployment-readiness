...
Protocol 0.1-rc.4-candidate.3; candidate criteria, not certification.
...
**How to check:** Ask who might be unable to use, correct, decline or challenge the workflow, and who could be affected without operating it. Inspect the linked success conditions and evidence, not just a checked box.
