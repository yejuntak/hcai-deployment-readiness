...
Read [claims and governance](claims-and-governance.md), the [update log](https://www.takyejun.com/research/ai-readiness/updates), and the [current verification record](/static/research/ai-readiness/rc4-candidate-3/rc4-test-results.json). These support scrutiny, not a claim to worldwide-standard status.
